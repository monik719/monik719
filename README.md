...
<h1>
  Hola soy Monica. ¡Encantada de conocerte!
...
* :telescope: Actualmente acabo de terminar un bootcamp y estoy ansiosa de seguir colocando en practica mis conocimientos :muscle:

* :seedling: Estoy estudiando :blue_book: y practicando :computer: lenguaje SQL y Python, sin dejar de lado las increíbles herramientas de Microsoft.

* :heartbeat: Me encanta descubrir nuevas formas de automatizar mi trabajo

* :mailbox: ¿Quieres contactar conmigo? [![Linkedin Badge](https://img.shields.io/badge/-Noelia-blue?
